...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		<div class="navbar-header">
			<img class="navbar-img" src="<%=request.getContextPath()%>/images/naru3.png"><a
				class="navbar-brand" href="<%=request.getContextPath()%>/view/mainPage"
			...
			<ul class="nav navbar-nav">
				...
				>조회 <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="<%=request.getContextPath()%>/account/accountList">조회</a></li>
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<c:if test="${sessionScope.login eq 1}">
				<li><a href="<%=request.getContextPath()%>/view/memberMyPage"><span
					...
					></span> 마이페이지</a></li>
				<li><a href="<%=request.getContextPath()%>/view/logout"><span
